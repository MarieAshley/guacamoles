...
ch1ending = """
The sun starts to set, and casts everything in a soft orange light. {Maxwell} decides to head back to the city, and prepare for his date with Pu. He takes two steps, sneezes, and trips over a tree root. The pinecone rolls out of his pocket.
...
Eight and thirteen are familiar numbers. {Maxwell} ponders if the pinecone and the sneezewort are somehow related. Are separate beings in nature, somehow related to one another?
...
It is night now, and {Maxwell} is still on the grassy hill, lost in thought, and running late for his date with Pu. In a panic, he realizes that he has nothing to give her! He starts running back to the city. He twists an ankle in a small sink hole and tumbles down the hill. Stunned, he rolls over and stares up at the night sky.

A white spiral spans overhead. {Maxwell} thinks back to the painting of the Whirlpool Galaxy, by Rosse. The spirals are so peaceful, harmonious even. It looks like a sea shell. Small in the beginning, and spiraling out bigger and bigger, but again in a systematic way.

Was the Earth and nature related to something much bigger, the Universe?

Shoot! His date. Sprinting now {Maxwell} finally makes it back to the city. He finds Pu by the library. Out of breath, embarrassed, he apologizes. Pu just watches him with an amused look on her heart shaped faced, her blue eyes peering into his soul.

“Looks like you just went on an adventure.”

“Heh, I really did. I have something to show you.” {Maxwell} leads her into the library, into a section that has a display of ordinary seashells.

“Look at these shells.” said {Maxwell}.

“I see them, they are so handsome. Look how they sparkle!”

“Yeah…” mutters {Maxwell}, briefly wondering if he should wear sea shells so that Pu would find him handsome. No… that idea was stupid. “Right, remember their pattern.”

{Maxwell} takes the painting of the Whirlpool Galaxy from his pocket and handed it to Pu.

“More sparkles!” exclaimed Pu.

“More spirals.” offered {Maxwell}.

{Maxwell} leads Pu outside of the library and out of the city a few steps, until the glare from the candle lights dimmed enough so they can view the night sky unobstructed.

“See the white streak across the sky?” ruminated {Maxwell}.
...
“You promised me dinner, {Maxwell}. I wanted to try guacamole.”

“Where are the guacamoles?”

Pu smiled at {Maxwell}. For being such a bright kid, with such a special mind, he could say some silly things.

“I am not sure. Surely, we can find an avocado or two somewhere in the city.” Pu took {Maxwell}’s hand and led him back into the city.
""".format(Maxwell = human.name)

while True:
    w = True
    while w:
        w = ch1.actions(input('action: '))
    ch1.describe_space(special_squares, types_of_squares)
